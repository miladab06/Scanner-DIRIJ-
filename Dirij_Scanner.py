 ...
 try:
   ...
   for admin in pages:
      ...
      if response.status_code == 200:
         ...
         print (Fore.GREEN+ '%s %s' % ('Admin page found!'+ '\t>>>' + '\t' +Style.RESET_ALL+Fore.RED + host,''+Style.RESET_ALL ))
         print('----------------------------------------------------------------------------------------------')
         ...
         #print (txt1 in line for txt1 in txt for line in page_content)
...
def os_detection(url):
   try:
      ...
      print('----------------------------------------------------------------------------------------------')
      print (Fore.GREEN+ '%s %s' % ( 'HostName IS \t>>>' + '\t' + url,''+Style.RESET_ALL+Fore.RED+ url +Style.RESET_ALL))
      print('----------------------------------------------------------------------------------------------')
      print (Fore.GREEN+ '%s %s' % ( 'HostIP IS \t>>>' + '\t' + url,''+Style.RESET_ALL+Fore.RED+ ip +Style.RESET_ALL))
      print('----------------------------------------------------------------------------------------------')

      return ip
      #response_content = response.content.splitlines()
...
def main(url):
   try:
      #print('1')
      #multi_thread_port_scan.scan_ports(url,1)
      #print('1-1')
      #Print (RES_SC_P)
      #print('2')
      ...
      if (not url.endswith('http://', 1, 8)):
         url2 =  'http://' + url
          ...
          print (url2)
         # Create new threads
      thread = threading.Thread( target = multi_thread_port_scan.scan_ports( ip , 2))  
...
try:
   ...
   print (Style.DIM+Fore.GREEN+'\t#  ########### [#] ####### ####   ###### ####### [#] ##############   #')
   print (Style.DIM+Fore.GREEN+'\t#                                                                     #')
   print (Style.DIM+Fore.GREEN+'\t#                                                      DIRIJ Scanner  #')
